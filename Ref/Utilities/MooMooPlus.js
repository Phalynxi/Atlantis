...
// @namespace    -
// @version     2.0
// @description Welcome To The Leading 2020 MooMoo.io Hack.
// @author       X
// @match        *://moomoo.io/*
...
// @icon         https://th.bing.com/th/id/OIP.y2URGFDTLMVu-8ra8raTPgHaHa?pid=Api&rs=1
// ==/UserScript==
var doinginsta = false;
var autopit = false;
let changelook = false;
let instaChat = " ~ X_MOD ~ "
let quadChat = "Leaving Tribe!" // You can change
$("#consentBlock").css({display: "none"});
//$("#youtuberOf").css({display: "none"});
if(changelook == true){
$("#mapDisplay").css({background: `url('https://i.imgur.com/ihSJ6Y6.png')`});
}
$('#ageBarContainer')['append']('<div style=\"width: 100%;position: absolute;top: 100px;text-align: center;color: aqua;font-size: 12px;\">\x0aR - Instakill | V - Spike | T - Toggle Auto heal | G - Spike + Boost | Q(hold) - Anti Insta|\x0a</div>')
document.getElementById("gameName").innerHTML = "✵ ~X~ ✵";
$('#gameName').css({'color': 'aqua',
...
document.getElementById("ageText").style.color = "aqua";
document.getElementById("allianceButton").style.color = "aqua";
document.getElementById("chatButton").style.color = "aqua";
document.getElementById("storeButton").style.color = "aqua";
document.getElementById("leaderboard").append('');
document.getElementById('loadingText').innerHTML = "Made By X";
document.getElementById("loadingText").style.color = "aqua";
let _1536E = false;
//https://i.imgur.com/ihSJ6Y6.png
//https://i.imgur.com/ihSJ6Y6.png
...
$("#gameCanvas").css('cursor', 'url(https://cur.cursors-4u.net/symbols/sym-6/sym580.cur), default');
...
let healSpeed = 150000; //COME BACK TO THE AUTOHEAL
...
document.addEventListener('keydown', (e)=>{
    ...
    if (e.keyCode == 76 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        setTimeout( () => {
            document.getElementById("woodDisplay").innerHTML = "Leave";
            document.getElementById("stoneDisplay").innerHTML = "Team";
            doNewSend(["9", [null]]);
        }, 75);
    }
   ...
   /* if(e.keyCode == 32 && document.activeElement.id.toLowerCase() !== 'chatbox') {
    ...
    if(e.keyCode == 77 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        if(healToggle == 0) {
            if(hatToggle == 0) {
                                document.title = "  autoHeal=off  autoHat: off"
                //doNewSend(["ch", ["  AutoHeal=off  AutoHat: off"]]);
            } else {
                document.title = " autoHeal=off  autoHat=on"
                //doNewSend(["ch", [" AutoHeal=off AutoHat=on"]]);
            }
...
document.title = "X MOD";
if(changelook == true){
document.getElementById("gameName").innerHTML = "X MOD";
document.getElementById("leaderboard").append('X MOD');
document.getElementById("diedText").innerHTML = " Oh well ";
...
document.getElementById("ageBar").style.color = "aqua";
...
<div id="simpleModal" class="modal">
    <div class="modal-content">
        <div class="modal-header"color: aqua>
            <span class="closeBtn">&times;</span>
            <h2 style="font-size: 30px; font:"Comic Sans MS; color: aqua";">Settings</h2>
            <h4 style="font-size: 10px; font:"Comic Sans MS; color: aqua";">No AutoChat = Blank</h4>
        </div>
        <div class="modal-body" style="font-size: 15px;">
            <div class="flexControl">
                <h3 style="color: aqua; font-size: 15px;">Hat Settings</h3>
                <h3 class="menuPrompt">Tank Gear: </h3> <input value="${String.fromCharCode(TankGearK)}" id="tankGear" class="keyPressLow" color="aqua" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                ...
                <hr>
                <h3 style="font-size: 15px; color: aqua">Auto respond</h3>
                ...
                <hr>
                <h3 style="font-size: 15px; color: aqua">Reccomended Optional Settings</h3>
