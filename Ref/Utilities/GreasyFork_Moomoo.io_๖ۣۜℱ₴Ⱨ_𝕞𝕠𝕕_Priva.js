// ==UserScript==
// @name         Moomoo.io ๖ۣۜℱ₴Ⱨ 𝕞𝕠𝕕 Private Version
// @namespace    none
// @version      3
// @description  Best Auto Heal Mod ( Esc to open menu )
// @author       HackPrivateGG
// @license      MIT
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/494386/Moomooio%20%E0%B9%96%DB%A3%DB%9C%E2%84%B1%E2%82%B4%E2%B1%A7%20%F0%9D%95%9E%F0%9D%95%A0%F0%9D%95%95%20Private%20Version.user.js
// @updateURL https://update.greasyfork.org/scripts/494386/Moomooio%20%E0%B9%96%DB%A3%DB%9C%E2%84%B1%E2%82%B4%E2%B1%A7%20%F0%9D%95%9E%F0%9D%95%A0%F0%9D%95%95%20Private%20Version.meta.js
// ==/UserScript==
...
let changes = `<div id="subConfirmationElement"><a href="https://www.youtube.com/channel/UC45zHuFS_APJWBHzGJFtvFQ">Youtube</a></div>`;
...
document.getElementById("gameName").innerHTML = "๖ۣۜℱ₴Ⱨ 𝕞𝕠𝕕";
let changes2 = `<div id="customMenuName"><h3 style="font-size: 50px;" class = "indent">💢-GG-💢</a></div>`;
...
document.getElementById("loadingText").innerHTML = `<div id="💢-GG-💢" class="loader">`
//document.getElementById("loadingText").innerHTML = "Please Wait..";
document.getElementById("diedText").innerHTML = "Sorry you dead :(";
document.getElementById("diedText").style.color = "#ffffff";
document.title = "๖ۣۜℱ₴Ⱨ 𝕞𝕠𝕕";
document.getElementById("leaderboard").append("Subscribe Uc45Hz !");
...
document.getElementById('promoImgHolder').innerHTML =
  ...
  p { font-size: 20px;}#noticationDisplay {
      ...
      <div>
  <i class="fa-solid fa-rectangle-list"style="font-size: 25px";></i><p>Update Next</p> <div style="font-size: 15px">
  - added Player Invisible<br>
  - added Revenge Insta<br>
  - Fix Bug AutoMild<br>
  - added Revenge Heal<br>
  Thx For Download My Hack:)<br>
...
if (enterGameButton) {
    enterGameButton.style.backgroundColor = "#8F00FF";
}
...
function handleMessage(m) {
    ...
    if (item == "O" && data[1] == myPlayer.id) {
        ...
        if (data[2] < 100 && data[2] > 00 && healToggle == true) {
            //normal heal
    ...
    for (const mutation of mutationsList) {
        if (mutation.target.id === "killCounter") {
            ...
            if (count > prevCount) {
                doNewSend(["6", ["NOOB!"]]);
                setTimeout(()=>{
                    doNewSend(["6", ["GG|FSH private mod|By base "]]);
                },650);
                prevCount = count;
            }
        }
...
$("body").after(`
  <div id="infomenu">
  <hr>
  <div class="nameblock">๖ۣۜℱ₴Ⱨ 𝕞𝕠𝕕</div>
  <hr>
  <ul>
  ...
  <hr>
  <div class="nameblock">HotKey:</div>
  <hr>
  ...
  <br> Thx For Download My Hack <br>
  <br> My youtube channel Uc45Hz <br>
  </ul>
  <hr>
  </div>
