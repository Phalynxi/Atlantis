// ==UserScript==
// @name         WoodMod(Wood#6638)
// @namespace    Best Hack 2020-Forever
// @version      4.5
// @description FAQ - Who BuTTons!
// @description  ||   ||   ||
// @description  \/   \/   \/
// @description F1 - AUTO HEAL ON/OFF
// @description F6 FUN HAT OFF/ON
// @description F7 FUN HAT OFF/ON
// @description > - Bow insta(for best inst need turret hat and 9age)
// @description Arrow UP - Automesseage my diss
// @description Arrow DOWN  - autoclan WoodMod
// @descriptionV Arrow -> - AutoClan #1
// @description Arrow <- - WoodMod version
// @description NUM7 - You can make your automesseage (but he bad for comfort)
// @description ESC - Hack Menu
// @description Z - TANK GEAR
// @description CTRL - CLEAR ALL Accessones
// @description SHIFT - Boost hack + Monkey Tail
// @description ESC - Clear all ACCESSONES AND HATS!
// @author       Ozen And Wood
// @match        *://moomoo.io/*
// @match        *://dev.moomoo.io/*
...
// @icon    https://cdn.vox-cdn.com/thumbor/Ie_7RzJw30PM6LzCpSMBqQpbmxs=/1400x1400/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/8792127/acastro_170629_1777_0008.jpg
// @downloadURL none
// ==/UserScript==
...
var YouName = window.prompt("Write `OP`, for anti-lag.","");
...
(() => {
	try {
		...
		const modules = new Collection([{
			id: "core",
			name: "Info",
			description: "HellO! Is TigerMD Fix by Wood . Wood Diss - Wood#6638",
			required: true,
			init: () => {
...
newImg.style = `position: absolute; top: 9999px; left: 80%; z-index: 100000; width: 100px; height: 100px; cursor: pointer;`;
document.body.prepend(newImg);
newImg.addEventListener("click", () => {
       let w = window.open("https://www.youtube.com/channel/UCjiuUcAX_hCOrS9mQbNCfqg", null, `height=650, width=1199, status=yes, toolbar=no, menubar=no, location=no`);
});
...
$("#menuButton").css({background: `url('https://klike.net/uploads/posts/2019-06/1560231206_1.jpg')`});
$("#allianceButton").css({background: `url('https://klike.net/uploads/posts/2019-06/1560231206_1.jpg')`});
$("#storeButton").css({background: `url('https://klike.net/uploads/posts/2019-06/1560231206_1.jpg')`});
$("#chatButton").css({background: `url('https://klike.net/uploads/posts/2019-06/1560231206_1.jpg')`});
...
! function(e) {
				...
				Bi(), setInterval(() => Bi(), 2500), e ? ft(e) : (ue.onclick = s.checkTrusted(
						...
						function() {
							setTimeout((function() {
								! function() {
									var e = xe.value,
										t = prompt("Copy or Pasty Server links", e);
	...
	var at = document.getElementById("featuredYoutube"),
		ot = [{
			name: "Wood",
			link: "https://www.youtube.com/channel/UCjiuUcAX_hCOrS9mQbNCfqg"
		}, {
			name: "Wood",
			link: "https://www.youtube.com/channel/UCjiuUcAX_hCOrS9mQbNCfqg"
		}, {
						...
						if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ ==
                          ...
                          if(!_.isPlayer){//animal tracers
							...
							_.health > 0 && (o.healthBarWidth, be.fillStyle = rt, be.roundRect(_.x -
								...
								_ == R || _.team && _.team == R.team ? "#00FF00" : "#FF0000", be.roundRect(
	...
	(function(e, i) {
		var r; /*! https://mths.be/punycode v1.4.1 by Wood#6638 */
		! function(s) {
  ...
  autoaim = true;
   ...
   if(e.keyCode == 112 && document.activeElement.id.toLowerCase() !== 'chatbox') {
       ...
       if(healToggle == 0) {
        ...
        if (autoaim == false) {
            autoaim = true;
        document.title = "WoodMod / Aim : On";
        } else {
        document.title = "WoodMod / Aim : Off";
            autoaim = false;
    }
    }
...
function animate(space, chance) {
   ...
   let characters;
   if(space) {
       characters = 'WoodMod God You Nub';
   } else {
       characters = 'WoodMod';
   }
   if(space) {
...
var _msgs = ["DeatMod", "WoodMod", "WoodMod", "WoodMod"];
var msgs = _msgs;
...
<div id="simpleModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 style="font-size: 17px;">WoodMod -> Hat Settings </h2>
        </div>
        ...
        <div class="modal-footer">
            <h3 style="font-size: 17px;">Made with love, From Wood#6638</h3>
            <p></p>
        </div>
    </div>
</div>
...
document.getElementById('enterGame').innerHTML = '𝓟𝖑𝖆𝔂';
document.getElementById("gameName").style.color = "White";
document.getElementById('loadingText').innerHTML = '▣Loading...▣ 99% ▉▊▋]';
document.getElementById('nameInput').placeholder = "Wood";
document.getElementById('chatBox').placeholder = "Nihao from Wood :D";
document.getElementById("pingDisplay").style.color = "#09ED59";
document.getElementById('diedText').innerHTML = '𝕲𝖆-𝕸𝖊 𝕺𝖛𝖊𝖗';
...
document.getElementById("leaderboard").style.color = "#1FDB02";
document.getElementById("gameName").style.color = "DarkOrange";
document.getElementById("setupCard").style.color = "WoodMod";
document.getElementById('gameName').innerHTML = 'WoodMod';
document.getElementById("promoImg").remove();
document.getElementById("woodDisplay").style.color = "Green";
document.getElementById("stoneDisplay").style.color = "Gray";
document.getElementById("killCounter").style.color = "DarkOrange";
document.getElementById("foodDisplay").style.color = "Red";
document.getElementById("ageText").style.color = "#09ED59";
document.getElementById("allianceButton").style.color = "#09ED59";
document.getElementById("chatButton").style.color = "#6CD979";
document.getElementById("storeButton").style.color = "#09ED59";
    $("#mapDisplay").css({background: `url('https://i.imgur.com/aGpK7hj.png')`});
$("#mapDisplay").css({
...
$('#storeButton').css({'color': '#09ED59'});

$('#chatButton').css({'color': '#09ED59)'});
...
'margin-bottom': '30px'});
        ...
        $('#joinPartyButton').css({'color': '#09ED59',
'text-shadow': '0 3px 0 rgba(231, 76, 60), 0 3px 0 rgba(231, 76, 60), 0 3px 0 rgba(231, 76, 60), 0 3px 0 rgba(231, 76, 60), 0 3px 0 rgba(231, 76, 60), 0 3px 0 rgba(231, 76, 60), 0 3px 0 rgba(231, 76, 60), 0 3px 0 rgba(231, 76, 60), 0 3px 0 rgba(255, 0, 0)',
'text-align': 'center',
'font-size': '20px',
'margin-bottom': '30px'});
...
$('#foodDisplay').css({'color': '#F05B6C'});
$('#killCounter').css({'color': 'White'});
$('#woodDisplay').css({'color': '#14911A'});
$('#stoneDisplay').css({'color': '#7A8487'});
$('#scoreDisplay').css({'color': '#F1F739'});
...
$("#ageBarContainer").append('</br><div id="hacktext"></div><div style="width: 100%;position: absolute;bottom: 94px;text-align: center;color:DarkOrange;font-size: 24px;" id="freetext"></div><div style="width: 100%;position: absolute;bottom: 144px;text-align: center;color: #ed3f00;font-size: 24px;" id="ptext"></div><div style="width: 100%;position: absolute;bottom: 224px;text-align: center;color: #9a008b;font-size: 24px;" id="ctext"></div><div style="width: 100%;position: absolute;top: 100px;text-align: center;color: DarkOrange;font-size: 12px;" id="bilgitext"></div><div style="width: 100%;position: absolute;bottom: 170px;text-align: center;color: DarkOrange;font-size: 24px;" id="atext"></div><div style="width: 100%;position: absolute;bottom: 196px;text-align: center;color: black;font-size: 24px;" id="mtext"></div>');

$( "#partyButton, #joinPartyButton" ).wrapAll( '<div class="partyWrap"></div>' );

$( "#linksContainer2 > a:nth-child(1)" ).replaceWith( '<a href="./docs/versions.txt" target="_blank" class="menuLink">WoodMod  - v5.0</a>' );

$( "#partyButton" ).replaceWith( '<span>Empty </span><i class="material-icons" style="font-size:30px;vertical-align:middle"></i>' );

$( "#errorNotification" ).after( '<div id="moddedMenu"><div class="titleMM">WoodMod</div><div class="one"><label class="switch"></span></label><div class="two"><div class="text"><b></span></label><label class="container">Auto Aim<input type="checkbox" id="autoaim"><span class="checkmark"></b></div></div>');
...
(function() {var css = [
	...
	"  ::-webkit-scrollbar {",
	"    width: 10px;",
	"    border-right: 2px solid #09ed59;",
	"  }",
	"",
	"  ::-webkit-scrollbar-thumb {",
	"    border: 2px solid #09ed59;",
	"  }",
	"",
	...
	"    color: #09ED59f!important;",
	"  }",
	"",
	"  #leaderboard, .leaderboardItem[style*=\"color: #1fdb02;\"] {",
	"    color: #09ED59!important;",
	"  }",
	"",
	"  .ytLink:hover {",
	...
	"    border-bottom: 3px solid #09ED59;",
	"  }",
	"",
	"  #moddedMenu {",
	"    position: absolute;",
...
autoaim.addEventListener('change', function() {
    if (this.checked) {
        autoaim = true
        doNewSend(["ch", ["Auto Aim : ON"]]);
    } else {
        autoaim = false
        doNewSend(["ch", ["Auto Aim : OFF"]]);
    }
})
...
getElement.style.backgroundColor = "Green";
getElement.style.color = "#09ed59";

$('#leaderboard').append(' ₣uĊkeŖ 24/7');
  ...
  if(document.getElementById("actionBarItem0")){
    ...
    if(document.getElementById("actionBarItem5").style.display === "inline-block"){
      ...
      for(Laa = 0; Laa < Math.round(aVZ[0][1]/5*2); Laa++){
        mk.beginPath();
        mk.lineWidth = 26;
        mk.strokeStyle = "rgb("+Math.rounzd(aNC[0]/255*235)+","+Math.round(aNC[1]/255*235)+","+Math.round(aNC[2]/255*235)+",0.5)";
