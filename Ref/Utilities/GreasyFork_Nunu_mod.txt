...
// @namespace    none
// @version      4
// @description  made by nunu, fz, ae86, and SOHH
// @author       Ae86, Liftic, SOHH
// @license      MIT
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/499429/Nunu%20mod.user.js
// @updateURL https://update.greasyfork.org/scripts/499429/Nunu%20mod.meta.js
// ==/UserScript==
...
/* KEYBINDS
    ...
    */
    ...
    while (password !== PASSWORD) {
        alert("you paid yet dont know the pass?");
...
document.getElementById("gameName").innerHTML = "Nunu mod"
let changes2 = `<div id="customMenuName"><h3 style="font-size: 50px;" class = "indent">you paid.</a></div>`;
...
document.getElementById("loadingText").innerHTML = `<div id=paid for this" class="loader">`
//document.getElementById("loadingText").innerHTML = "Please Wait..";
document.getElementById("diedText").innerHTML = "you can kill them!";
document.getElementById("diedText").style.color = "#ffffff";
document.title = "๖ۣۜℱ₴Ⱨ 𝕞𝕠𝕕";
document.getElementById("leaderboard").append("Nunu approved");
...
(function () {
    ...
    madeByLabel.textContent = "Made by Ae86 and nunu";
