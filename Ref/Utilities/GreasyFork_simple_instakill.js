...
// @match        *://*moomoo.io/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/427995/simple%20instakill.user.js
// @updateURL https://update.greasyfork.org/scripts/427995/simple%20instakill.meta.js
// ==/UserScript==
...
function hatAcc(hatid, accid){
    doNewSend(["13c", [1, hatid, 0]]);
    doNewSend(["13c", [0, hatid, 0]]);
    doNewSend(["13c", [0, 0, 1]]);
    doNewSend(["13c", [1, accid, 1]]);
    doNewSend(["13c", [0, accid, 1]]);
}
...
document.addEventListener('keydown', function(e){
    switch(document.activeElement.id.toLowerCase() !== 'chatbox'){
        case true:
            switch(e.keyCode){
                case 82:
                autoaim = true;
