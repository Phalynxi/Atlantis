...
// @match        *://abc.moomoo.io/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/448775/SophiaMod%21%21.user.js
// @updateURL https://update.greasyfork.org/scripts/448775/SophiaMod%21%21.meta.js
// ==/UserScript==
...
// pigs do not show names in this mod
/*var password = "sophia is the best name";
var response;
var entryCount = 0;
var entryLimit = 1000;
var error = false;
...
while(response != password && !error){
    if(entryCount < entryLimit){
        response = window.prompt("Do you want to see all the cows named Sophia? Well then enter the password.");
        entryCount++;
    } else {
        error = true;
    }
...
, function(e, t, n) {
    var i = new (n(49));
    i.addWords("trash", "trash", "jew", "black", "baby", "child", "white", "porn", "pedo", "trump", "clinton", "hitler", "nazi", "gay", "pride", "sex", "pleasure", "touch", "poo", "kids", "rape", "white power", "nigga", "nig nog", "doggy", "rapist", "boner", "nigger", "nigg", "finger", "nogger", "nagger", "nig", "fag", "gai", "pole", "stripper", "penis", "vagina", "pussy", "nazi", "hitler", "stalin", "burn", "chamber", "cock", "peen", "dick", "spick", "nieger", "die", "satan", "n|ig", "nlg", "cunt", "c0ck", "fag", "lick", "condom", "anal", "shit", "phile", "little", "kids", "free KR", "tiny", "sidney", "ass", "kill", ".io", "(dot)", "[dot]", "mini", "whiore", "whore", "faggot", "github", "1337", "666", "satan", "senpa", "discord", "d1scord", "mistik", ".io", "senpa.io", "sidney", "sid", "senpaio", "vries", "asa");
    var r = Math.abs
      , s = Math.cos
      , a = Math.sin
      , o = Math.pow
...
, function(e, t, n) {
    ...
    e.exports = class {
        ...
        replaceWord(e) {
            return e.replace(this.regex, "sophia").replace(this.replaceRegex, this.placeHolder)
        }
        clean(e) {
            return e.split(/\b/).map(e=>this.isProfane(e) ? this.replaceWord(e) : e).join("sophia")
        }
        addWords() {
...
, function(e, t) {
    e.exports = function(e, t, n, i, r, s, a, o, c) {
        this.aiTypes = [{
            id: 0,
            name: "sophia sophia sophia sophia sophia sophia sophia sophia sophia sophia",
            src: "cow_1",
            killScore: 150,
            health: 500,
            weightM: .8,
...
document.title = "sophia mod";
document.getElementById('gameName').innerHTML = 'big proe';