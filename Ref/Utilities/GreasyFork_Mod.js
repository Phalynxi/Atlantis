...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/486585/Mod.user.js
// @updateURL https://update.greasyfork.org/scripts/486585/Mod.meta.js
// ==/UserScript==
...
/*Mod Log
    V1 - Created BEST MOD 2024, devlopment beings
...
document.getElementById("gameName").innerHTML = "BESTMODEVER";
let changes2 = `<div id="customMenuName"><h3 style="font-size: 50px;" class = "indent">By BoamDaToober</a></div>`;
...
//document.getElementById("loadingText").innerHTML = "BESTMODEVER Loading";
document.getElementById("diedText").innerHTML = "You Are Better Than This!";
document.getElementById("diedText").style.color = "#ffffff";
document.title = " BESTMODEVER";
document.getElementById("leaderboard").append("BESTMODEVER");
...
document.getElementById('promoImgHolder').innerHTML =
  ...
  p { font-size: 20px;}#noticationDisplay {
      ...
      <div>
  <i class="fa-solid fa-rectangle-list"style="font-size: 25px";></i><p>Update V1.5</p> <div style="font-size: 15px">
  - added boost tick<br>
  ...
  - added accesories <br>
  <i class="fa-solid fa-rectangle-list"style="font-size: 25px";></i><p>Update V1.25</p> <div style="font-size: 15px">
  - Created BESTMODEVER, devlopment beings<br>
...
const enterGameButton = document.getElementById("TROLL BUTTON");
if (enterGameButton) {
...
const nameInputElement = document.getElementById("PutDaName");
if (nameInputElement) {
...
setTimeout(() => {
	document.getElementById('gameName').innerHTML = '★';
	setTimeout(() => {
		document.getElementById('gameName').innerHTML = '★B';
		setTimeout(() => {
			document.getElementById('gameName').innerHTML = '★Be';
			setTimeout(() => {
				document.getElementById('gameName').innerHTML = '★Bes';
				setTimeout(() => {
					document.getElementById('gameName').innerHTML = '★Best';
					setTimeout(() => {
						document.getElementById('gameName').innerHTML = '★BestM';
						setTimeout(() => {
							document.getElementById('gameName').innerHTML = 'BestMo';
							setTimeout(() => {
								document.getElementById('gameName').innerHTML = '★BestMod';
								setTimeout(() => {
									document.getElementById('gameName').innerHTML = '★BestMod!';
									setTimeout(() => {
										document.getElementById('gameName').innerHTML = '★BestMod✔';
...
setInterval(function () {
    if (myPlayer.hat == 45) {
        doNewSend(["6", ["I love you plz no kill *;::;*"]]);
    }
    ...
    for (const mutation of mutationsList) {
        if (mutation.target.id === "killCounter") {
            ...
            if (count > prevCount) {
                doNewSend(["6", ["+1 kill"]]);
                setTimeout(()=>{
                    doNewSend(["6", ["1+ Noob Down The Drain..."]]);
                },650);
                prevCount = count;
            }
        }
...
$("body").after(`
  <div id="infomenu">
  <hr>
  <div class="nameblock">BESTMODEVER v1.75</div>
  <hr>
  <ul>
