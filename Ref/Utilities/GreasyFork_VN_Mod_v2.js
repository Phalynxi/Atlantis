...
// @namespace    none
// @version      2
// @description  Remaked auto healing and instakill aded fps boost
// @author       Mrlag & HaX
// @license      MIT
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/525919/VN%20Mod%20v2.user.js
// @updateURL https://update.greasyfork.org/scripts/525919/VN%20Mod%20v2.meta.js
// ==/UserScript==
...
setInterval(()=>{
    if(automill == true && isNextToFriendlyMill == false && millCount < 298 && automilling == false){
        automilling = true;
        doNewSend(["z",[millType, null]])
        doNewSend(["F",[1, (movementDirection - 1.90)]])
        doNewSend(["F",[0, (movementDirection - 1.90)]])
        doNewSend(["z",[myPlayer.weapon, true]])
        doNewSend(["z",[millType, null]])
        doNewSend(["F",[1, (movementDirection - 3.14)]])
        doNewSend(["F",[0, (movementDirection - 3.14)]])
        doNewSend(["z",[myPlayer.weapon, true]])
        doNewSend(["z",[millType, null]])
        doNewSend(["F",[1, (movementDirection + 1.90)]])
        doNewSend(["F",[0, (movementDirection + 1.90)]])
