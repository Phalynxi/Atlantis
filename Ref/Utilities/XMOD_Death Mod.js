...
// @icon    https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTAg5B9eJdzMX9EIoAnuVoxABKW_idO2O_gFdOUEYrkTXb_ZRlH
// @downloadURL none
// ==/UserScript==
...
(() => {
	try {
		...
		categoryChoose.append("<option disabled>Fixed By Bextiyar</option>");
...
document.getElementById('enterGame').innerHTML = '~|⚡☠ P̶̉̄L̵͒́A̴͒͂Y̵̌͝ ☠⚡|~';
document.getElementById("gameName").style.color = "Red";
document.getElementById('loadingText').innerHTML = '. . . . . . . . . L̴̐̒o̷̩̊a̴̓͘d̴͛̕ ̴̫̈́Ď̷͝ȅ̶̋Ȁ̶̐t̶̄̀H̵̾́M̶̅̓ö̴́͆d̵͒́ . . . . . . . . . .';
document.getElementById('nameInput').placeholder = "☠Ď̶͔ĕ̴̍A̴̛͆t̷͑̑H̷̦̄M̶͋̒ò̷̇d̵̑̈́☠";
document.getElementById('chatBox').placeholder = "☠Ď̶͔ĕ̴̍A̴̛͆t̷͑̑H̷̦̄☠";
document.getElementById("pingDisplay").style.color = "red";
document.getElementById('diedText').innerHTML = '⚡☠G̴̓́ä̷̐m̸̅͋e̷͂͝ ̸́̕O̸͒͒v̴͆̕ë̷̝́r̴̓͛☠⚡';
...
document.getElementById('gameName').innerHTML = ' ☢⚡☠Ď̶͔ĕ̴̍A̴̛͆t̷͑̑H̷̦̄M̶͋̒ò̷̇d̵̑̈́☠⚡☢ ';
...
$('#leaderboard').append('☣Ď̷͝ȅ̶̋Ȁ̶̐t̶̄̀H̵̾́M̶̅̓ö̴́͆d̵͒́☣');
