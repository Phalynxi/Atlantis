...
document.getElementById('gameName').innerHTML = '??BloodyMod??';
...
document.getElementById("leaderboard").append ('??BloodyMod??');
document.getElementById('diedText').innerHTML = '??????BlodyDied??????';
document.getElementById('diedText').style.color = "red";
document.getElementById('nameInput').placeholder = "MaximumTears";
...
document.getElementById("scoreDisplay").style.color = "#ff0000";
document.getElementById("woodDisplay").style.color = "#ff0000";
document.getElementById("stoneDisplay").style.color = "#ff0000";
document.getElementById("killCounter").style.color = "#ff0000";
...
const healer = repeater(81, () => {place(foodType);
                                   place(foodType);
                                   place(foodType)}, 50);
...
document.addEventListener('keydown', (e)=>{
    ...
    if (e.keyCode == 79 && document.activeElement.id.toLowerCase() !== '') {
        for (let i=0;i<5;i++){
    ...
    if (e.keyCode == 78 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        place(millType, myPlayer.dir + toRad(72));
    }
    ...
    if (e.keyCode == 85 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        doNewSend(["ch", [" 1 age INSTEAD"]]);
    }
    if (e.keyCode == 76 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        doNewSend(["ch", ["BULLETS"]]);
    }
    if (e.keyCode == 32 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        doNewSend(["ch", ["SPIKED"]]);
    }
    if (e.keyCode == 40 && document.activeElement.id.toLowerCase() !== '') {
        doNewSend(["9", [null]]);
    }
    if (e.keyCode == 9 && document.activeElement.id.toLowerCase() !== '') {
        if (myPlayer.y < 2400){
...
var _msgs = ["BloodyMod", "BloodyMod OP", "BloodyMod OP?", "BloodyMod OP!"];
var msgs = _msgs;
...
! function(e) {
    ...
    (function(t) {
        e.exports.maxScreenWidth = 1920, e.exports.maxScreenHeight = 1080, e.exports
            .serverUpdateRate = 9, e.exports.maxPlayers = 999999, e.exports.maxPlayersHard = 999999, e.exports.collisionDepth = 6, e.exports.minimapRate = 3e3, e.exports.colGrid =
            ...
            .nameY = 34, e.exports.skinColors = ["#FFF700", "#FF0000", "#0000", "#2A1F3", "#000000", "#c37373", "#4c4c4c", "#ecaff7", "#738cc3", "#9100ff"
			...
			199999999, e.exports.mapScale = 14400, e.exports.mapPingScale = 40, e.exports.mapPingTime =
			2200
	}).call(this, n(41))
}, function(e, t) {
	var n = {
	...
	function Ct() {
		if (At[0]) {
			...
			s.removeAllChildren(Ze), Ze.style.display = "block", s.generateElement({
				...
				class: "notifButton",
				html: "<i class='material-icons' style='font-size:28px;color:#FF0000;'>&#xE876;</i>",
				parent: Ze,
				onclick: function() {
					Dt(1)
				},
    ...
    document.onkeydown = function(e) {// 褋锌邪屑 械写芯泄. 袧袝校袘袝?袗袡孝袝 袟袗袛袝?袞袣校!! 袧褍 械褋谢懈 胁芯芯斜褖械 泻褌芯 褌芯 褝褌芯 胁懈写懈褌 褌芯 褝褌芯 锌芯 褌芯屑褍 褔褌芯 械褋谢懈 胁褘 褍斜械褉械褌械 械械 褌芯 胁 泻芯薪褑械 芯褌 褋邪屑芯谐芯 泻谢懈械褌邪 斜褍写械褌 薪邪卸邪褌邪 q 褌芯斜懈褕褜 械写邪 ))
        if (e.keyCode == 101) {
            Sn(R.items[0])
            r.send("c", 1)
            r.send("c", 0)
    ...
    //r.send("5") = 锌褉芯褕谢芯械 "谐谢邪胁薪芯械" 芯褉褍卸懈械
    //Sn(R.items[0]) = 械写邪
    //Sn(R.items[1]) = 褋褌械薪邪
    //Sn(R.items[2]) = 褋锌邪泄泻 懈谢懈 卸械 褕懈锌
    //Sn(R.items[3]) = 屑械谢褜薪懈褑邪
    //Sn(R.items[4]) = 褌褉邪锌泻邪 懈谢懈 卸械 斜褍褋褌(械褋谢懈 褝褌芯谐芯 锌褉械写屑械褌邪 薪械褌褍 褌芯 褌褘 斜械褉械褕 锌褉懈屑邪褉懈 懈谢懈 褋械泻芯薪写邪褉懈 芯褉褍卸懈械
    //Sn(R.items[5]) = 褌褍褌 屑芯懈 锌芯谢薪芯屑芯褔懈褟 褍卸械 胁褋械, 芯泻芯薪褔械薪褘
    var repeater = function(key, action, interval) {
    let _isKeyDown = false;
    let _intervalId = undefined;
		...
		if (!i) {
			...
			if (a.translate(r.width / 2, r.height / 2), a.rotate(s.randFloat(0, Math.PI)),
				...
				for (var c, l = 0; l < 2; ++l) ai(a, 7, c = _.scale * (l ? .5 : 1), .7 *
						c), a.fillStyle = t ? l ? "#EAAFA0" : "#E17156" : l ? "#E17156" :
					"#E17156", a.fill(), l || a.stroke();
			else if (1 == e.type)
				if (2 == t) a.fillStyle = "#EAAFA0", ai(a, 6, .3 * e.scale, .71 * e.scale),
					a.fill(), a.stroke(), a.fillStyle = "#EAAFA0", si(0, 0, .55 * e.scale, a),
					a.fillStyle = "#EAAFA0", si(0, 0, .3 * e.scale, a, !0);
				else {
					var h;
					! function(e, t, n, i) {
						var r, a = Math.PI / 2 * 3,
					...
					}(a, 0, _.scale, .7 * _.scale), a.fillStyle = t ? "#EAAFA0" : "#EAAFA0",
						a.fill(), a.stroke(), a.fillStyle = t ? "#EAAFA0" : "#EAAFA0";
					var u = T / 4;
				...
				"#EAAFA0" : "#EAAFA0" : "#EAAFA0", ai(a, 3, e.scale, e.scale), a.fill(),
				a.stroke(), a.fillStyle = 2 == e.type ? 2 == t ? "#EAAFA0" : "#EAAFA0" :
				"#EAAFA0", ai(a, 3, .55 * e.scale, .65 * e.scale), a.fill());
			i = r, ti[n] = i
		}
		return i
	}
	...
	function ri(e, t) {
		...
		if (!n || t) {
			...
			if (r.translate(i.width / 2, i.height / 2), r.rotate(t ? 0 : Math.PI / 2),
				...
				e.name) {
				r.fillStyle = "#EAAFA0", si(0, 0, e.scale, r), r.fillStyle = "#FF8484";
				var a = -Math.PI / 2;
				! function(e, t, n, i, r) {
				...
				r.fillStyle = "#FF3434", si(0, 0, e.scale, r), r.fillStyle = "#EAAFA0";
				...
				var h, u;
				for (r.fillStyle = "#EAAFA0", si(0, 0, e.scale, r), r.fillStyle =
					"#EAAFA0", o = T / (h = 4), c = 0; c < h; ++c) si((u = s.randInt(e.scale /
					2.5, e.scale / 1.7)) * Math.cos(o * c), u * Math.sin(o * c), s.randInt(
					4, 5), r, !0)
			} else if ("wood wall" == e.name || "stone wall" == e.name ||
				"castle wall" == e.name) {
				r.fillStyle = "castle wall" == e.name ? "#A6FF82" : "wood wall" == e.name ?
					"#EAFFE2" : "#050D02";
				var f = "castle wall" == e.name ? 4 : 3;
				ai(r, f, 1.1 * e.scale, 1.1 * e.scale), r.fill(), r.stroke(), r.fillStyle =
					"castle wall" == e.name ? "#9da4aa" : "wood wall" == e.name ? "#050D02" :
					"#FEFFFE", ai(r, f, .65 * e.scale, .65 * e.scale), r.fill()
			} else if ("spikes" == e.name || "greater spikes" == e.name ||
				"poison spikes" == e.name || "spinning spikes" == e.name) {
				r.fillStyle = "poison spikes" == e.name ? "#ff0000" : "#939393";
				var d = .6 * e.scale;
				ai(r, "spikes" == e.name ? 5 : 6, e.scale, d), r.fill(), r.stroke(), r.fillStyle =
					"#ff0000", si(0, 0, d, r), r.fillStyle = "#c9b758", si(0, 0, d / 2, r, !
						0)
			} else if ("windmill" == e.name || "faster windmill" == e.name ||
				"power mill" == e.name) r.fillStyle = "#FEFFFE", si(0, 0, e.scale, r), r.fillStyle =
				"#FFBF05", ci(0, 0, 1.5 * e.scale, 29, 4, r), r.fillStyle = "#1D1706", si(
					0, 0, .5 * e.scale, r);
			else if ("mine" == e.name) r.fillStyle = "#939393", ai(r, 3, e.scale, e.scale),
				r.fill(), r.stroke(), r.fillStyle = "#ff0000", ai(r, 3, .55 * e.scale,
					.65 * e.scale), r.fill();
			else if ("sapling" == e.name)
				for (c = 0; c < 2; ++c) ai(r, 7, d = e.scale * (c ? .5 : 1), .7 * d), r.fillStyle =
					c ? "#ff0000" : "#ff0000", r.fill(), c || r.stroke();
			else if ("pit trap" == e.name) r.fillStyle = "#ff0000", ai(r, 3, 1.1 * e.scale,
				1.1 * e.scale), r.fill(), r.stroke(), r.fillStyle = it, ai(r, 3, .65 * e
				.scale, .65 * e.scale), r.fill();
			else if ("boost pad" == e.name) r.fillStyle = "#ff0000", oi(0, 0, 2 * e.scale,
			...
			else if ("turret" == e.name) r.fillStyle = "#ff0000", si(0, 0, e.scale, r),
			...
			B = Date.now(), P = B - q, q = B,
				function() {
					...
					o.snowBiomeTop - d <= 0 && o.mapScale - o.snowBiomeTop - d >= ce ? (be.fillStyle =
							"	#DAA520", be.fillRect(0, 0, oe, ce)) : o.mapScale - o.snowBiomeTop -
						d <= 0 ? (be.fillStyle = "#FF4500", be.fillRect(0, 0, oe, ce)) : o.snowBiomeTop -
						d >= ce ? (be.fillStyle = "#ff0000", be.fillRect(0, 0, oe, ce)) : o.snowBiomeTop -
						d >= 0 ? (be.fillStyle = "#ff0000", be.fillRect(0, 0, oe, o.snowBiomeTop -
							d), be.fillStyle = "#DAA520", be.fillRect(0, o.snowBiomeTop - d, oe,
							ce - (o.snowBiomeTop - d))) : (be.fillStyle = "#DAA520", be.fillRect(0,
								0, oe, o.mapScale - o.snowBiomeTop - d), be.fillStyle = "#FF4500", be
							...
							1, be.fillStyle = "#FF4500", qn(f, d, be, o.riverPadding), be.fillStyle =
							"#00FFFF", qn(f, d, be, 250 * (ee - 1))), be.lineWidth = 4, be.strokeStyle =
...
///猓库？猓库？猓库？猓熲７猓库？猓库?光猓锯猓嗏 光／猓库？猓库？猓库？猓库？猓库？猓库？猓库？猓库？猓