// ==UserScript==
// @name        SamMod V-0.5 | 2020 | best hack | better insta
// @namespace    -
// @version     0.5
// @description yes
// @author       disgusted Duke
// @match        *://moomoo.io/*
...
let instaChat = "SamMod V-0.5=OP by sam#7707"
...
$('#ageBarContainer')['append']('<div style=\"width: 100%;position: absolute;top: 100px;text-align: center;color: red;font-size: 12px;\">\x0aR - Instakill | H - 2 Turrets | Up Arrow - Toggle Message Spam (Adjust in settings)| V - Spike | T Toggle Auto heal | G - Spike + Boost | N - Mill | Ctrl - Anti Spike Pit | Q(hold) - Anti Insta| BackSpace Go To Nearest Enemy Toggle | Esc - Menu | Home - Katana Musket\x0a</div>')
document.getElementById("gameName").innerHTML = "Sam Mod V-0.5";
...
document.getElementById("leaderboard").append('SamMod 0.5');
document.getElementById('loadingText').innerHTML = "Instakill and Macro Menu by Sam, Modified By MythicalPenguin";
...
if(e.keyCode == 82 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        autoaim = true;
         doNewSend(["ch", ['SaMMod V-0.5=OP by sam#7707']]);
...
document.title = "Sam Mod";
if(changelook == true){
document.getElementById("gameName").innerHTML = "Sam Mod";
document.getElementById("leaderboard").append('Sam Mod');
